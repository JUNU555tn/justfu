...
def is_youtube_url(url):
    ...
    youtube_patterns = [
        ...
        # Add more generic video sites
        r'(?:https?://)?(?:www\.)?(?:pornhub\.com)',
        r'(?:https?://)?(?:www\.)?(?:xvideos\.com)',
        r'(?:https?://)?(?:www\.)?(?:redtube\.com)',
        r'(?:https?://)?(?:www\.)?(?:tube8\.com)',
        r'(?:https?://)?(?:www\.)?(?:youporn\.com)',
        r'(?:https?://)?(?:www\.)?(?:xhamster\.com)',
        r'(?:https?://)?(?:www\.)?(?:xnxx\.com)',
        r'(?:https?://)?(?:www\.)?(?:spankbang\.com)',
        r'(?:https?://)?(?:www\.)?(?:txxx\.com)',
        r'(?:https?://)?(?:www\.)?(?:hqporner\.com)',
        r'(?:https?://)?(?:www\.)?(?:eporner\.com)',
        r'(?:https?://)?(?:www\.)?(?:porn\.com)',
        r'(?:https?://)?(?:www\.)?(?:beeg\.com)',
        r'(?:https?://)?(?:www\.)?(?:motherless\.com)',
        r'(?:https?://)?(?:www\.)?(?:upornia\.com)',
        r'(?:https?://)?(?:www\.)?(?:gotporn\.com)',
        r'(?:https?://)?(?:www\.)?(?:pussyboy\.net)'
    ]
